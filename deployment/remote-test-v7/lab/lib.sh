...
load_release_manifest() {
  ...
  while IFS= read -r raw || [[ -n "$raw" ]]; do
    ...
    case "$key" in
      RELEASE_FORMAT|PACKAGE_RELEASE_ID|TITRA_VERSION|TITRA_TEST_IMAGE|TITRA_TEST_IMAGE_ID|TITRA_CONFIG_IMAGE_ID|TITRA_IMAGE_ARCHIVE|MONGO_TEST_IMAGE|MONGO_TEST_IMAGE_ID|MONGO_CONFIG_IMAGE_ID|MONGO_SOURCE_DIGEST|MONGO_IMAGE_ARCHIVE|SOURCE_COMMIT|SOURCE_CONTEXT_SHA256|TITRA_IMAGE_EVIDENCE_DIRECTORY|TITRA_IMAGE_EVIDENCE_SHA256SUMS_SHA256|STOCK_IMAGE|STOCK_IMAGE_ID|V5_IMAGE|V5_IMAGE_ID|V6_IMAGE|V6_IMAGE_ID|V6_CONFIG_IMAGE_ID|V6_IMAGE_ARCHIVE)
        ;;
      *)
