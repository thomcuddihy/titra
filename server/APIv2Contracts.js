  ...
  return {
    ...
    deployment: {
      ...
      security: {
        ...
        oidcVerifiedEmailLinkingEnabled: oidcVerifiedEmailLinkingEnabled === true,
        oauthEncryptionConfigured: oauthEncryptionConfigured === true,
        publicProjectsDisabled: publicProjectsDisabled === true,
        unsafeLegacyScriptsEnabled: unsafeLegacyScriptsEnabled === true,
      },
    },
    limits: {
      taskCodePoints: 1000,
